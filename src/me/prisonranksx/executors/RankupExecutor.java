...
public interface RankupExecutor extends PromotionExecutor {
    ...
    public static final Set<UUID> AUTO_RANKUP_PLAYERS = new HashSet<>();

    public static final Set<UUID> MAX_RANKUP_PLAYERS = Sets.newConcurrentHashSet();

    public final Set<UUID> MAX_RANKUP_BREAKER = Sets.newConcurrentHashSet();
