...
public class HeavyBukkit {
	...
	private static final JavaPlugin PLUGIN = JavaPlugin.getProvidingPlugin(HeavyBukkit.class);
	...
	public static class IntPreparedLoop {
		 ...
		 * 
		 * @param action          action to perform
		 * @param maxMilliseconds {@link HeavyBukkit#prepareTask(double)}
		 * @return LoopFuture
		 */
